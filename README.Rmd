...
The goal of iHealth is to provide an easy API to work with data exported from Apple Health. 
...
Read data exported from Apple Health into a data frame (note, this can take a couple minutes):
